if defined?(Wice::Defaults)
  ...
  Wice::Defaults::DEFAULT_TABLE_CLASSES = ['table', 'table-striped']
  ...
  #Wice::Defaults::ADDITIONAL_COLUMN_PROCESSORS = {
  #  job_application_job_filter:    ['NameColumnJobApplication',   'ConditionsGeneratorColumnJobApplication'],
  #  job_application_company_filter:    ['NameCompanyColumnJobApplication',   'ConditionsGeneratorColumnCompanyJobApplication'],
  #  job_name_filter:    ['NameColumnJob',   'ConditionsGeneratorColumnNameJob'],
  #  job_company_filter:    ['CompanyColumnJob',   'ConditionsGeneratorColumnCompanyJob'],
  #  job_application_user_filter:    ['NameUserColumnJobApplication',   'ConditionsGeneratorColumnUserJobApplication'],
  #}
